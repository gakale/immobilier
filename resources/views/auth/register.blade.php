...
<!-- Mirrored from booking.webestica.com/sign-up.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 26 Apr 2024 19:55:02 GMT -->
<head>
		...
		<div class="m-auto row justify-content-center align-items-center">
			<div class="col-12">
				<div class="overflow-hidden shadow bg-mode rounded-3">
					<div class="row g-0">
						<!-- Vector Image -->
						<div class="order-2 col-lg-6 d-md-flex align-items-center order-lg-1">
